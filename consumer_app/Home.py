...
with st.sidebar:
    ...
    nav_items = [
        ("🚀", "Start", "pages/1_🚀_Start.py"),
        ("🌿", "My Plot", "pages/2_🌿_My_Plot.py"),
        ("💬", "Chat", "pages/3_💬_Chat.py"),
        ("📅", "Schedule", "pages/4_📅_Schedule.py"),
        ("👤", "Account", "pages/5_👤_Account.py"),
        ("📷", "Plant Camera", "pages/6_📷_PlantCamera.py"),
        ("🎉", "Celebration", "pages/7_🎉_Celebration.py"),
        ("🔔", "Alerts", "pages/9_🔔_Alerts.py"),
    ]
    for emoji, label, path in nav_items:
        if st.button(f"{emoji}  {label}", use_container_width=True, type="secondary"):
            st.switch_page(path)
