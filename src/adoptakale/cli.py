...
Usage:
    adoptakale dashboard         # launch Streamlit dashboard
    adoptakale solve             # run a one-shot Layer 2 solve and print the plan
    adoptakale forecast          # print Layer 1 forecast for every crop
"""
