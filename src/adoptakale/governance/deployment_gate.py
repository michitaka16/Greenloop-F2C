...
def _check_vrp_solve_time() -> CriterionResult:
    ...
    try:
        from adoptakale.layer4.vrp import solve_vrp
    ...
    try:
        result = subprocess.run(
            [
                ...
                "--cov=adoptakale.layer1",
                "--cov=adoptakale.layer2",
                "--cov=adoptakale.layer3",
...
def _check_typhoon_recovery() -> CriterionResult:
    ...
    try:
        from adoptakale.layer2.scenarios import apply_typhoon, TyphoonScenarioInput
...
def _check_drift_detection() -> CriterionResult:
    ...
    if found and schedule_found:
        try:
            from adoptakale.monitoring.drift_detector import get_all_drift_checks
