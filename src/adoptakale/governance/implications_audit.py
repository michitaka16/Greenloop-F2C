...
_IMPLICATIONS: list[Implication] = [
    ...
    Implication(
        ...
        evidence="src/adoptakale/layer4/features.py (feature selection comments)",
        is_mitigated=True,
    ),
    # =======================================================================
    ...
    Implication(
        ...
        evidence="src/adoptakale/layer2/optimizer.py (MODE_LABELS, diversity constraint); "
                 "src/adoptakale/layer2/hitl.py",
        is_mitigated=True,
    ),
    # =======================================================================
    ...
    Implication(
        ...
        evidence="src/adoptakale/layer3/autonomy_gate.py (AutonomyGate, "
                 "AutonomyMode.ADVISORY default); src/adoptakale/layer2/optimizer.py "
    ...
    Implication(
        ...
        evidence="src/adoptakale/layer5/admin_mode.py; "
...
_STAKEHOLDER_IMPACTS: list[StakeholderImpact] = [
    ...
    StakeholderImpact(
        ...
        positive_effects=[
            ...
            "B2B licensing opportunity — Adopt a Kale software on Greenphyto hardware",
